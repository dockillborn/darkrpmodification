...
RP_MySQLConfig.Host = "89.34.96.142" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
RP_MySQLConfig.Username = "noxious1_dockillborn" -- This is the username to log in on the MySQL server.
                                -- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
RP_MySQLConfig.Password = "YTaZVSXPtuUKxgz-Ce7imcMh2AqdyR" -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = "noxious1_gmod-ngrp" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
